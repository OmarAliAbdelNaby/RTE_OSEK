...
if __name__ == '__main__':
    ...
    task1 = ['T1', 3, 'FULL', 1, 'TRUE', 'EXTENDED', 128, 2, 2, ['Ev1', 'EV2'], ['Res1', 'Res2']]
    task2 = ['T2', 2, 'FULL', 1, 'FALSE', 'EXTENDED', 128, 1, 1, ['Ev2'], ['Res3']]
    #task3 = ['T3', 2, 'FULL', 1, 'FALSE', 'EXTENDED', 128, 2, 1, ['Ev2','EV4'], ['Res2']]
    ...
    #NewXML.AddTask(task3)
    #testTaskgg = ['gg', 1, 'FULL', 1, 'TRUE', 'EXTENDED', 128, 5, 0, ['e1', 'e2', 'e3', 'e4', 'e5'], []]
    #testTask = ['Ga3foor', 3, 'FULL', 1, 'TRUE', 'EXTENDED', 128, 5, 0, ['e1', 'e2', 'e3', 'e4', 'e5'], []]
    #NewXML.AddTask(testTask)
    #NewXML.AddTask(testTaskgg)
    '''
