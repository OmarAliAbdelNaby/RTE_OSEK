...
#ifndef TASK_2_EVENT_1
    #define TASK_2_EVENT_1       Null
#endif

#ifndef TASK_2_EVENT_2
    #define TASK_2_EVENT_2       Null
#endif
...
OsCounter CounterStruct[NUMBER_OF_COUNTER] = { 
                                        ...
                                        { 
                                          .MaxAllowedValue = OS_COUNTER_MAX_ALLOWED_VALUE_2,
                                          .TicksPerBase = OS_COUNTER_TICKS_PER_BASE_2,
                                          .MinCycle = OS_COUNTER_MIN_CYCLE_2,
                                        },
#endif
#if NUMBER_OF_COUNTER >= 3
                                        { 
                                          .MaxAllowedValue = OS_COUNTER_MAX_ALLOWED_VALUE_3,
                                          .TicksPerBase = OS_COUNTER_TICKS_PER_BASE_3,
                                          .MinCycle = OS_COUNTER_MIN_CYCLE_3,
                                        },
#endif
};
#endif
