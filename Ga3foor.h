...
#define TASK_2_NUMBER_OF_EVENT_IN_TASK	0
#define TASK_2_NUMBER_OF_RES_IN_TASK	0
/*************************** ALARM CONFIGURATION ****************************/
...
#define OS_EVENT_NAME_4					RTE_Event_E2
